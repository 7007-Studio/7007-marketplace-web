...
const newTradingRecord = (): TradingRecord => {
  return {
    ...
    status: faker.helpers.shuffle<TradingRecord["status"]>(["buy", "sell"])[0]!,
...
export default function BasicTrading() {
  ...
  const renderTradingRecords = (records: TradingRecord[]) => {
    return records.map((record, index) => (
      <tr
        key={index}
        style={{ color: record.status === "buy" ? "#1D9E4B" : "#F64646" }}
      >
        <td>{record.status}</td>
        <td>{record.createdAt.toLocaleString()}</td>
        <td>{record.price}</td>
        <td>{record.amount}</td>
        <td style={{ color: "#2B8BFC" }}>
          {" "}
          <a href={`https://etherscan.io/address/${record.link}`}>
            <ExternalLink />
          </a>
        </td>{" "}
        {/* Example currency */}
    ...
    <>
      <div className="grid grid-cols-12 gap-4 font-bold">
        ...
        <div className="col-span-4 ">
          {isChecked ? "ADVANCED TRADE MODE" : "BASIC TRADE MODE"}
        </div>
        ...
        <div className="col-span-4">
          <div className="flex justify-center items-start">
            <div className="flex justify-center items-center gap-4">
              ...
              <span style={{ color: isChecked ? "#2B8BFC" : "" }}>
                ADVANCED
              </span>
            </div>
          </div>
            ...
            <div className="col-span-6 2xl:col-span-8">
              <div className="2xl:w-1/2 flex justify-start items-center">
                <ul className="menu menu-vertical lg:menu-horizontal text-white/50">
                  ...
                  >
                    <a className={clickedItem === "1" ? "text-white" : ""}>
                      1HR
                    </a>
                  </li>
                  <li
                  ...
                  >
                    <a className={clickedItem === "6" ? "text-white" : ""}>
                      6HR
                    </a>
                  </li>
                  <li
                  ...
                  >
                    <a className={clickedItem === "24" ? "text-white" : ""}>
                      24HR
                    </a>
                  </li>
                  <li
                  ...
                  >
                    <a className={clickedItem === "168" ? "text-white" : ""}>
                      7DAYS
                    </a>
                  </li>
                  <li
                  ...
                  >
                    <a
                      className={clickedItem === "1000000" ? "text-white" : ""}
                    >
                      ALL
                    </a>
                  </li>
          ...
          <div>
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-2 flex items-center font-bold">
                <button className="btn font-bold bg-white w-[250px] h-[45px] flex items-center justify-center">
                  TRADE
                </button>
              </div>
            </div>
      ...
      {!isChecked && (
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-8 flex flex-col gap-2">
                ...
                <div className="col-span-4 flex justify-between items-center gap-2">
                  <div className="flex justify-between border-2 border-gray-700 rounded-lg w-[313px] h-[79px]">
                    <input
                      ...
                      className="h-full input w-full max-w-xs bg-transparent border-none focus:outline-none"
                    />
                  ...
                  <div className="flex flex-col w-[220px]">
                    <div className="dropdown">
                      <div
                        tabIndex={0}
                        role="button"
                        style={{ backgroundColor: "#313131CC" }}
                        className="btn m-1 w-[220px] h-[40px] text-white"
                      >
                        <img
                          className="w-[20px]"
                          src="https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/512/Ethereum-ETH-icon.png"
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-3"></div>
              <div className="col-span-3 flex justify-center  my-5 scale-125">
                {" "}
                <ChevronDown />
              </div>
            </div>
            ...
            <div>
              <div className="grid grid-cols-6 gap-4">
                <div className="text-white/70 col-span-2 mb-2">
                  You Recieved
                </div>
              </div>
              <div className="grid grid-cols-6 gap-4">
                  ...
                  <div className="flex flex-col w-[220px]">
                    <div className="dropdown">
                      <div
                        ...
                        role="button"
                        style={{ backgroundColor: "#313131CC" }}
                        className="btn text-white m-1 w-[220px] h-[40px]"
                      >
                        CHOOSE TOKEN <ChevronDown />
                      </div>
                      <ul
                        tabIndex={0}
                        style={{ backgroundColor: "#313131CC" }}
