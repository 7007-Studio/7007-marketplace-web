...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const documentHashMap = {
    a89ed2b25b1294a73a2d0d42ccc2a19e31c99f567504faf5fcaa7946ca91b104:
      GraphQueryDocument,
  };
  ...
  return {
    ...
    get documents() {
      return [
        {
          document: GraphQueryDocument,
          get rawSDL() {
            return printWithCache(GraphQueryDocument);
          },
          location: "GraphQueryDocument.graphql",
          sha256Hash:
            "a89ed2b25b1294a73a2d0d42ccc2a19e31c99f567504faf5fcaa7946ca91b104",
        },
      ];
...
export type GraphQueryQueryVariables = Exact<{ [key: string]: never }>;

export type GraphQueryQuery = {
  newListings: Array<
    Pick<
      NewListing,
      | "listingId"
...
export const GraphQueryDocument = gql`
  query GraphQuery {
    newListings(orderBy: listing_listingId) {
      listingId
      listingCreator
      listing_tokenId
      listing_status
...
` as unknown as DocumentNode<GraphQueryQuery, GraphQueryQueryVariables>;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GraphQuery(
      variables?: GraphQueryQueryVariables,
      options?: C
    ): Promise<GraphQueryQuery> {
      return requester<GraphQueryQuery, GraphQueryQueryVariables>(
        GraphQueryDocument,
        variables,
        options
      ) as Promise<GraphQueryQuery>;
    },
  };
}
